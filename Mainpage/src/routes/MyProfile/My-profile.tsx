    ...
    <div className="profile-background">
      <div className="container-profile-photo">
        ...
        <div className="background-picture-profile">
          <img className="profile-picture" src="data:image/png;base64, iVBORw0KGgoAAAANSUhEUgAAAAUA
    AAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO
        9TXL0Y4OHwAAAABJRU5ErkJggg==" alt="profile picture"/>
        </div>
      ...
      <div className="container-profile-info">
        ...
        <div className="container-profile-recent"></div>
      </div>
    </div>
